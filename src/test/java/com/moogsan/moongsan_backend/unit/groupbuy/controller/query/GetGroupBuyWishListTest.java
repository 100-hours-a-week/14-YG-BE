...
import com.moogsan.moongsan_backend.groupbuy.presentation.controller.query.GroupBuyWishListController;
...
import static com.moogsan.moongsan_backend.groupbuy.domain.message.ResponseMessage.GET_WISH_SUCCESS;
import static org.mockito.ArgumentMatchers.eq;
import static org.springframework.restdocs.mockmvc.RestDocumentationRequestBuilders.get;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.jsonPath;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.status;

@WebMvcTest(controllers = GroupBuyWishListController.class)
@ActiveProfiles("test")
