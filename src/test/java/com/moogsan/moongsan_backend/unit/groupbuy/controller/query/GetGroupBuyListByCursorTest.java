...
import com.moogsan.moongsan_backend.domain.groupbuy.service.GroupBuyQueryService.GetGroupBuyListByCursor;
...
public class GetGroupBuyListByCursorTest {
    ...
    @MockBean
    private GetGroupBuyListByCursor getGroupBuyListByCursor;
